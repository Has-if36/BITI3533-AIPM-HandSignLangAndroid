...
title = [
            ...
            "Dist 19", "Dist 20", "Dist 21", "Dist 22", "Dist 23", "Dist 24", "Dist 25", "Dist 26", "Dist 27",
            "Dist 28", "Dist 29", "Dist 30", "Dist 31", "Dist 32", "Dist 33", "Dist 34", "Dist 35", "Dist 36",
            "Dist 37", "Dist 38", "Dist 39", "Dist 40", "Dist 41", "Dist 42", "Dist 43", "Dist 44"
        ]
    ...
    while succ:
        ...
        if pressedKey == 10 or pressedKey == 13:
            ...
            if data:
                ...
                if not os.path.exists(r"./HandRecBaseV3_output"):
                    os.mkdir(r"./HandRecBaseV3_output")

                csv_file = filename + ".csv"
                while os.path.exists(os.path.join(r"./HandRecBaseV3_output", csv_file)):
                    i += 1
                    filename = "read_" + str(i)
                    csv_file = filename + ".csv"

                if not os.path.exists(os.path.join(r"./HandRecBaseV3_output", csv_file)):
                    path = os.path.join(r"./HandRecBaseV3_output", csv_file)
                    df.to_csv(path, index=False)

                text_file = filename + ".txt"
                if os.path.isfile(os.path.join(r'.\\HandRecBaseV3_output', text_file)):
                    f = open(os.path.join(r'.\\HandRecBaseV3_output', text_file), "w")
                else:
                    f = open(os.path.join(r'.\\HandRecBaseV3_output', text_file), "x")
